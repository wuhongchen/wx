...
if($_W['ispost']) {
	...
	$wechat = array_elements(array('switch', 'account', 'signkey', 'partner', 'key'), $_GPC['wechat']);
	...
	if($wechat['switch'] && (empty($wechat['account']) || empty($wechat['signkey']) || empty($wechat['partner']) || empty($wechat['key']))) {
